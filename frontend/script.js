...
const setTimeBtn = document.getElementById("btn");


setTimeBtn.onclick = function () {
    let time = Number(document.getElementById('sec').value);
    ...
    exercises = [
        { name: "High Knee", src: "../video/high_knee.mp4", duration: time },
...
resetTimeBtn.addEventListener("click", () => {
    ...
    timerElement.textContent = timeLeft;
    if (!isPaused) countdown = setInterval(updateTimer, 1000);
});
